...
Full roster for **Teyvat University**. Characters get a dedicated doc once they
**appear** in the story (lazy-loading rule). Everyone else is listed here for
reference and gets a doc when they cross Aether's path.

**Status key:** ✅ Has doc / appeared · 🕓 Not yet appeared

---

## Core Cast (Aether's world)

| Character | College / Role | Romance | Status | Doc |
|---|---|---|---|---|
...
## Romance Options (female only, slow burn)
...
## Recurring Cast (non-romance)

**Sumeru STEM (Aether's department):**
...
| **Kazuha** | Creative writing minor; found in the campus garden | 🕓 | — |

---

## Wider Roster (referenced by college, not yet met)
